...
public class EntitySerializerTests {
    ...
    @Test
    public void write() {
        DefaultEntityCreator entityCreator = new DefaultEntityCreator();
        DefaultComponentCreator componentCreator = new DefaultComponentCreator();
        EntitySerializer serializer = new EntitySerializer(entityCreator, componentCreator);
